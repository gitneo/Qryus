...
@Component({
  selector:'qryus-question-detail',
  template:`
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-9 mb-2">
              <div class="mb-2">
                <h1>How to install Java 20 on my Linux Server</h1>
              </div>
              <div class="post">
...
<!--                          </span>-->
                      ...
                      <div class="post clearfix">
                        <div class="user-block">
                          ...
                          <span class="username">
                          <a href="#" class="text-maroon">Sarah Ross</a>
                      ...
                      <div class="post">
                        <div class="user-block">
                          ...
                          <span class="username">
                          <a href="#" class="text-maroon">Adam Jones</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
